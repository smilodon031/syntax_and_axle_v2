  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="flex flex-col items-center">
        <span className="text-[10px] font-bold text-neon-cyan uppercase tracking-widest mb-1">Drive Mode</span>
      ...
      >
        ...
        {/* Snap Points */}
        <div className="absolute inset-y-8 flex flex-col justify-between items-center pointer-events-none">
        ...
        <motion.div
          ...
          style={{ y }}
          className={`z-10 w-16 h-20 rounded-2xl bg-gradient-to-br from-zinc-700 to-zinc-900 border border-white/10 shadow-2xl cursor-grab active:cursor-grabbing flex flex-col items-center justify-center gap-1 ${disabled ? 'opacity-50 grayscale' : ''}`}
        >
          {/* Grip Lines */}
          ...
          {/* Status Light */}
          <div className={`mt-2 w-2 h-2 rounded-full transition-colors duration-300 ${
